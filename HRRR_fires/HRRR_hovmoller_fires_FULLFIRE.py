...
sDATE = datetime(UTC_now.year, UTC_now.month, UTC_now.day, UTC_now.hour)-timedelta(days=5)
...
# The demisions of the box will be (halfbox*2*3)km**2 
...
for s in spex:
    ...
    for stn in locations.keys():
        ...
        #
        plt.savefig(SAVE+'%s.png' % (S['MW var']))
