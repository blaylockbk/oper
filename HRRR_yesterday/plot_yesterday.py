...
def make_plots(inputs):
    ...
    SAVEDIR = '/uufs/chpc.utah.edu/common/home/u0553130/public_html/oper/HRRR_yesterday/%s/%s/' % (MAP_DIR, DOMAIN)
...
if __name__ == '__main__':
    ...
    sDATE = datetime(yesterday.year, yesterday.month, yesterday.day, 0)
    eDATE = datetime(today.year, today.month, today.day, 0)
    ...
    if DOMAIN == 'CONUS':
        ...
        location = '39.75,-111.75'   # A MesoWest ID or a 'lat,lon'
        background = 'arcgis'    # arcgis, arcgisSat, arcgisRoad, terrain, landuse

    MAP_DIR = '500mb_TMP_p05p95'

    
    plot_codes = {1:{'MAP_DIR' : 'Simulated_Radar',
                     'plotcode': 'dBZ_Fill'},
                  2:{'MAP_DIR' : '500mb_TMP_p05p95',
                     'plotcode': '500HGT_Contour,2mTemp_p95p05_fill'},
                  3:{'MAP_DIR' : '500mb_DPT_p05p95',
                     'plotcode': '500HGT_Contour,2mDPT_p95p05_fill'},
                  4:{'MAP_DIR' : '500mb_UVspd_p95',
                     'plotcode': '500HGT_Contour,10mWind_p95_fill'},
                  5:{'MAP_DIR' : 'RedFlag_criteria',
                     'plotcode': 'RedFlag_Fill'},
                  6:{'MAP_DIR' : 'RedFlag_potential',
                     'plotcode': 'RedFlagPot_Fill'},
                  7:{'MAP_DIR' : 'Precip_1hr',
    ...
    #for i in [4]:
        ...
        DATES = [sDATE + timedelta(hours=h) for h in range(0,hours)]
        FXX = range(0, 19)

        VARS = [[VALIDDATE, fxx] for VALIDDATE in DATES for fxx in FXX]
